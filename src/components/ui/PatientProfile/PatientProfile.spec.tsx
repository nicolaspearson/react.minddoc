...
describe('PatientProfile component', () => {
	...
	it('renders', () => {
		...
		expect(wrapper.find('PatientProfile')).toHaveLength(1);
	});

	it('renders snapshot correctly', () => {
		const wrapper = Enzyme.shallow(<PatientProfile patient={patient} />);
	...
	it('should mount component', () => {
		...
		expect(wrapper.children(PatientProfile).length).toEqual(1);
	});
});
