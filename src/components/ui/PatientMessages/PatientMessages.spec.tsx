...
describe('PatientMessages component', () => {
	...
	it('renders', () => {
		...
		expect(wrapper.find('PatientMessages')).toHaveLength(1);
	});

	it('renders snapshot correctly', () => {
		const wrapper = Enzyme.shallow(<PatientMessages patient={patient} />);
	...
	it('should mount component', () => {
		...
		expect(wrapper.children(PatientMessages).length).toEqual(1);
	});
});
